...
public class code_search {
	...
	public void codesearch(String osType) {
		...
		String address = lvalues.getFLTserverUri() + "/api/v1/code_search?codeType=OS";
	    String output;
		...
		try {
		    ...
		    if(jsonObj1.get("code").toString().equals("100")) {
	            ...
	            for(int i=0; i < dataArray.size(); i++) {
                    ...
                    if(tempObj.get("cdDtlNm").toString().equals(osType)) {
                    	pvalues.setFLTcodeosType(tempObj.get("cdDtlNo").toString());
                    }
                }
		    ...
		    System.out.println();
		    System.out.println("OS Type: " + osType + "  OS Code: " + pvalues.getFLTcodeosType());		    
