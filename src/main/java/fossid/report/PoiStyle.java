...
public class PoiStyle {
	...
	XSSFCellStyle sh0TitleFormat1 = excelVal.getWB().createCellStyle();
	XSSFFont font1 = excelVal.getWB().createFont();
	
	XSSFCellStyle sh0TitleFormat2 = excelVal.getWB().createCellStyle();
	XSSFFont font2 = excelVal.getWB().createFont();
	
	XSSFCellStyle sh0TitleFormat3 = excelVal.getWB().createCellStyle();
	XSSFFont font3 = excelVal.getWB().createFont();	
