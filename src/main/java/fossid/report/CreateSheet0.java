...
public class CreateSheet0 extends PoiStyle{
	...
	XSSFSheet sheet0 = excelVal.getSheet0();
	...
	public void writeSheet() {		
		...
		System.out.println();
		System.out.println("Create FossID report");
		
		setStyle();
		
		sheet0 = excelVal.getWB().createSheet("SRC");
		...
		for(int i = 0; i < idValues.getfilepath().size(); i++) {
			...
			cell = row.createCell(1);				
			cell.setCellStyle(sh0TitleFormat3);		
			cell.setCellValue(idValues.getfilepath().get(i).toString());
			
			cell = row.createCell(2);				
			cell.setCellStyle(sh0TitleFormat3);		
			cell.setCellValue(idValues.getcomponenetName().get(i).toString());
			
			cell = row.createCell(3);				
			cell.setCellStyle(sh0TitleFormat3);		
			cell.setCellValue(idValues.getcomponentVersion().get(i).toString());			
			
			cell = row.createCell(4);				
			cell.setCellStyle(sh0TitleFormat3);		
			cell.setCellValue(idValues.getcomponentLicenseId().get(i).toString());
			
			cell = row.createCell(5);				
			cell.setCellStyle(sh0TitleFormat3);		
			cell.setCellValue(idValues.getcomponentDownload().get(i).toString());
			
			cell = row.createCell(6);				
			cell.setCellStyle(sh0TitleFormat3);		
			cell.setCellValue(idValues.getcomponentHompage().get(i).toString());
			
			cell = row.createCell(7);				
			cell.setCellStyle(sh0TitleFormat3);		
			cell.setCellValue(idValues.getCopyright().get(i).toString());
			...
			cell = row.createCell(9);				
			cell.setCellStyle(sh0TitleFormat3);		
			cell.setCellValue(idValues.getcommnet().get(i).toString());
			
		}
		
		System.out.println("The FossID report file is created");
